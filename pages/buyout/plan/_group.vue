                ...
                <div>
                    <template v-if="!showActions">
                        <div  class="h-full flex gap-8 items-center">
                            <div class="w-52">
                                <v-select :items="sort_opt" label="" v-model="sort" dense outlined hide-details="auto" class="rounded-lg bg-white"/>
                            </div>
                            <div>
                      ...
                      >
                        ...
                        <template v-slot:item.size="{ item }">
                            <template v-if="item.can_be_edited">
                                <v-select :items="item.sizes" label="" v-model="item.size" dense outlined hide-details="auto" class="rounded-lg bg-white"/>
                            </template>
                ...
                <div class="mt-12">
                    ...
                    <v-data-table
                      ...
                      >
                        ...
                        <template v-slot:item.size="{ item }">
                            <v-select :items="item.size_opt" label="" v-model="item.size" dense outlined hide-details="auto" class="rounded-lg bg-white"/>
                        </template>
                        <template v-slot:item.gender="{ item }">
